...
> R: Pone al carrito en un estado inicial valido para que las demas funciones puedan trabajar correctamente con el. 
...
> R:El bug esta en la linea 23, total += c->items[i].precio;

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R:Deberia multiplicar el precio por la cantidad del producto
...
> R:El test falla, el 5to carrito_agregar devuelve 1, cuando deberia devolver 0.
...
> R:Si, la linea 29 ya que esa funcion nunca fue ejecutada por los test. 
...
> R:El test unitario prubea una funcion de manera aisalada, mientras que el de integracion prueba como funcionan varias juntas. El bug carrito total lo detecto el test unitario.
...
> R:Ya que en c no se controlan automaticamente los limites, a diferencia de python o java. 
...
> R:Es mejor porque permite detectar los errores y comprobar el comportamiento real del programa. 
...
> R:Porque al multiplicar por la cantidad = 1 no modifica el resultado, mientras que en cantidad 2 el resultado esperado es el doble. 
